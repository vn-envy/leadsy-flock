...
- Asset kit ratios live in [design.md](design.md). One Veo 8s 9:16 (audio) master + ffmpeg crops cover Feed / square / Stories; 9:16 may carry Indic captions (`clip-captioned`). No IAB GIF pack, no zip, no autopost. Live proof: fictional **Noya Salon** `noya-salon-7384033d` (`paper` theme) at `GET /k/{id}`.
